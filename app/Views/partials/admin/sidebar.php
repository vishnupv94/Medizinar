...
$draftTestimonials   = Testimonial::countDraft();
$draftTeam           = TeamMember::countDraft();
$draftContent        = SiteContent::countDraft();
...
$links = [
    ...
    ['href' => '/admin/testimonials',   'key' => 'testimonials', 'label' => 'Testimonials',    'badge' => $draftTestimonials, 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>'],
    ['href' => '/admin/team',           'key' => 'team',         'label' => 'Team Members',    'badge' => $draftTeam,         'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>'],
    ['href' => '/admin/content',        'key' => 'content',      'label' => 'Site Content',    'badge' => $draftContent,      'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h7"/>'],
