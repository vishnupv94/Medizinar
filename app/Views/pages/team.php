...
<section class="py-16 bg-white">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center fade-in-up">
        ...
        <div class="max-w-2xl mx-auto mt-8">
            <img src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=800&auto=format&q=80"
                 alt="Medizinar Care team"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            foreach ($team as $i => $member): ?>
                <button type="button"
                    ...
                    data-initial="<?= h($member['initial']) ?>"
                    data-color="<?= h($member['color']) ?>"
                    data-photo="<?= h($member['photo']) ?>"
                    data-bio="<?= h($member['bio']) ?>"
                    onclick="openTeamModal(this)">
                    <div class="pt-8 px-5 pb-6">
                        <!-- full-bleed photo -->
                        <img src="<?= h($member['photo']) ?>"
                             alt="<?= h($member['name']) ?>"
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center px-5
                            ...
                            <h3 class="font-extrabold text-white text-lg leading-tight mb-2 tracking-wide uppercase"><?= h($member['name']) ?></h3>
                            <p class="text-white/90 text-xs font-semibold tracking-widest uppercase mb-5"><?= h($member['role']) ?></p>
        ...
        <div id="team-modal" role="dialog" aria-modal="true" aria-labelledby="modal-name"
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8 text-center z-10">
                ...
                <img id="modal-photo" src="" alt="" class="team-photo mb-4 mx-auto" style="width:120px;height:120px;border-radius:18px">
                <h3 id="modal-name" class="text-xl font-bold text-gray-800 mb-1"></h3>
                <span id="modal-role" class="inline-block text-xs font-semibold px-3 py-1 rounded-full text-white mb-5"></span>
