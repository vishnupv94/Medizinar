 ...
 * Variables: $district (array), $slug (string)
 */
?>

<?php partial('inner-hero', [
    'heroTitle'       => h($district['heroTitle']),
    'heroDescription' => h($district['heroDesc']),
            ...
            <div class="lg:col-span-2 fade-in-up">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php foreach ($district['localities'] as $loc): ?>
                ...
                <?php
                $services = [
                    ['slug' => 'bedside-patient-care', 'name' => 'Bedside Patient Care', 'desc' => 'Professional home care for patients recovering from illness or surgery.'],
                    ['slug' => 'elderly-care',         'name' => 'Elderly Care',         'desc' => 'Daily living assistance, mobility support, and companionship for senior citizens.'],
                    ['slug' => 'mother-baby-care',     'name' => 'Mother & Baby Care',   'desc' => 'Postnatal care for new mothers and newborns at home.'],
                    ['slug' => 'home-maid-services',   'name' => 'Home Maid Services',   'desc' => 'Verified domestic staff for cleaning, cooking, and household support.'],
                    ['slug' => 'nri-parent-care',      'name' => 'NRI Parent Care',      'desc' => 'Regular home visits and well-being updates for parents of NRI families.'],
                    ['slug' => 'quick-support',        'name' => 'Quick Support',        'desc' => 'Short-term care for hospital visits, day support, and emergency needs.'],
                ];
                ?>
                <div class="grid sm:grid-cols-2 gap-4">
                    <?php foreach ($services as $svc): ?>
                        <a href="<?= url('/services/' . $svc['slug']) ?>"
                            ...
                            <p class="font-semibold text-gray-800 text-sm group-hover:text-primary-700 transition-colors"><?= h($svc['name']) ?></p>
                            <p class="text-gray-500 text-xs mt-1 leading-relaxed"><?= h($svc['desc']) ?></p>
                        </a>
                    <?php endforeach; ?>
                </div>
            </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        $allDistricts = [
            ...
            'kottayam' => 'Kottayam', 'ernakulam' => 'Ernakulam',
            'idukki' => 'Idukki', 'thrissur' => 'Thrissur',
            'palakkad' => 'Palakkad', 'malappuram' => 'Malappuram',
            'kozhikode' => 'Kozhikode', 'wayanad' => 'Wayanad',
            'kannur' => 'Kannur', 'kasaragod' => 'Kasaragod',
        ];
        unset($allDistricts[$slug]);
        ?>
        <div class="flex flex-wrap justify-center gap-2 fade-in-up">
            <?php foreach ($allDistricts as $dSlug => $dName): ?>
                <a href="<?= url('/location/' . $dSlug) ?>"
